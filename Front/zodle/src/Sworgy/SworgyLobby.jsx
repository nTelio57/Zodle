...
export default function SworgyLobby({onBeginClick, roomCode, isHost, playerList}) {

    return (
        <Box sx={{width: "100%", height:"100%", display:"flex", flexDirection: "column", justifyContent: "space-evenly", alignItems: "center"}}>

            <Typography style={{color: "white", fontSize: "22px"}}>Room code: {roomCode}</Typography>
            ...
            <Box visibility={isHost ? 'visible' : 'hidden'}>
