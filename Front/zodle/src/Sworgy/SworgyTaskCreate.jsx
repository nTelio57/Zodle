    ...
    return (
        <Box sx={{ height: "100%", width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
            <Box sx={{ height: "60%", width: "80%"}}>
                <TextField multiline onChange={(change) => setTask(change.target.value)} placeholder="Create your task for someone ;)" rows={22} fullWidth style={{ backgroundColor: "white", borderRadius: "4px"}}></TextField>
            </Box>
